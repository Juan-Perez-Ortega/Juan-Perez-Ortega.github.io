...
date: 2025-02-05 10:00:00 +0100
categories: [Windows, Medium]
tags: [tryhackme, windows, wordpress, cve-2017-0213, privilege-escalation]
image: /windows/Retro/image.png
---
...
![image.png](/windows/Retro/image.png)
...
![image.png](/windows/Retro/image%203.png)

Accedemos a internet para ver cual es el avatar 

![image.png](/windows/Retro/image%204.png)
...
![image.png](/windows/Retro/image%205.png)
...
![image.png](/windows/Retro/image%206.png)

![image.png](/windows/Retro/image%207.png)
...
![image.png](/windows/Retro/image%208.png)

Escribimos la shell reversa y actualizamos los cambios

![image.png](/windows/Retro/image%209.png)
...
![image.png](/windows/Retro/image%2010.png)
...
![image.png](/windows/Retro/image%2011.png)
...
![image.png](/windows/Retro/image%2012.png)
...
1. **Bypass de UAC:** * En la ventana de advertencia de UAC, hacemos clic en **"Show more details"**.
    ...
    ![image.png](/windows/Retro/image%2013.png)
...
![VirtualBox_KaliLinuxMaquinaasVirtuales_05_04_2026_22_37_43.png](/windows/Retro/VirtualBox_KaliLinuxMaquinaasVirtuales_05_04_2026_22_37_43.png)
...
![image.png](/windows/Retro/image%2014.png)

Una vez le damos a run nos abre un cmd con permisos de superusuario 

![image.png](/windows/Retro/image%2015.png)
